...
export default function Player(props){
    ...
    return(
        <div className="container-fluids" >
            <Link style={{ position: 'absolute', right: 0, top: 0,backgroundColor: '#04AA6D',borderColor:'darkblue', textDecoration:'none' }} className="btn btn-danger btn-lg m-3" onClick={() => ReactDOM.render(<UserProfile />, document.getElementById('Box'))}>
                &nbsp;&nbsp;&nbsp;
